  ...
  "fixed z-[70] gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
        ...
        bottom:
          "inset-x-0 bottom-0 border-t pb-24 sm:pb-6 data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
        left: "inset-y-0 left-0 h-full w-3/4 border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-sm",
        right:
          "inset-y-0 right-0 h-full w-3/4 border-l pb-24 sm:pb-6 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-sm",
      },
    },
    defaultVariants: {
      side: "right",
  ...
  ({ side = "right", className, children, ...props }, ref) => (
    <SheetPortal>
      ...
      <SheetPrimitive.Content 
        ...
        style={{
          paddingTop: side === 'right' || side === 'left' ? 'calc(var(--safe-area-top) + 1rem)' : undefined,
          paddingBottom: side === 'right' || side === 'left' || side === 'bottom' 
            ? 'max(calc(var(--safe-area-bottom) + 5rem), 6rem)' 
            : undefined,
        }}
        {...props}
      >
