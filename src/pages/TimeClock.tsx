...
import { Clock, Play, Square, Calendar, Loader2, Eye, Pencil, Coffee, FileText, Briefcase, History, MapPin, ChevronLeft, ChevronRight } from 'lucide-react';
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between">
                        <p className="text-sm font-medium">{format(new Date(entry.clock_in), 'EEE, MMM d')}</p>
