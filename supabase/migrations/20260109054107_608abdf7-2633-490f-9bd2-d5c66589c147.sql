-- Drop and recreate get_company_for_user to include missing document numbering columns
...
BEGIN
  ...
  SELECT 
    ...
    -- NEW: next numbers and hyphens settings
    c.job_next_number,
    c.quote_next_number,
    c.invoice_next_number,
    c.job_number_use_hyphens,
    c.quote_number_use_hyphens,
    c.invoice_number_use_hyphens,
    c.created_at,
    c.updated_at
  FROM companies c
