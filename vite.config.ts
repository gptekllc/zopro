...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "ZoPro - Field Service Management",
        short_name: "ZoPro",
        description: "Field service management platform for plumbing, HVAC, electrical, and general service companies.",
        theme_color: "#1e40af",
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          {
            // Cache Supabase storage bucket files (cache-first)
